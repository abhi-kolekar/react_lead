                ...
                <ul className="navbar-nav navbar-nav-right">
                    ...
                    <Dropdown >
                        ...
                        <div className="nav-profile-text">
                            <p className="mb-1 text-black"><Trans>{userInfo.name}</Trans></p>
                        </div>
                        </Dropdown.Toggle>
                    ...
                    <Dropdown >
                        ...
                        <Dropdown.Item className="dropdown-item preview-item" onClick={evt =>evt.preventDefault()}>
                            ...
                            <img src={require("../assets/images/faces/face1.jpg")} alt="user" className="profile-pic"/>
                            </div>
                        ...
                        <Dropdown.Item className="dropdown-item preview-item" onClick={evt =>evt.preventDefault()}>
                            <div className="preview-thumbnail">
                            <img src={require("../assets/images/faces/face3.jpg").default} alt="user" className="profile-pic"/>
                            </div>
                            <div className="preview-item-content d-flex align-items-start flex-column justify-content-center">
                    ...
                    <Dropdown >
                        ...
                        <Dropdown.Menu className="dropdown-menu navbar-dropdown preview-list">
                        <h6 className="p-3 mb-0"><Trans>Reminder</Trans></h6>
                        <div className="dropdown-divider"></div>
                        <Dropdown.Item className="dropdown-item preview-item" onClick={evt =>evt.preventDefault()}>
                            <div className="preview-thumbnail">
                            <div className="preview-icon bg-success">
                        ...
                        <div className="dropdown-divider"></div>
                        <h6 className="p-3 mb-0 text-center cursor-pointer"><Trans>See All Reminder</Trans></h6>
                        </Dropdown.Menu>
                    </Dropdown>
                    </li>
